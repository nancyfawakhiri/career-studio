        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-white/70 leading-relaxed max-w-xl">
              We’ll send occasional product updates (no spam). Be the first to try
              new features like personality assessments, college search, and new
              libraries.
            </p>
          </div>
          ...
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              alert("Thanks! Newsletter wiring comes next.");
            }}
          >
